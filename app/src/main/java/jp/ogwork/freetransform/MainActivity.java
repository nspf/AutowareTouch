...
public class MainActivity extends RosActivity {
    ...
    private ProgressBar gas_circle;
    private ProgressBar brake_circle;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gas_circle = (ProgressBar) findViewById(R.id.circularprogressbar1);
        brake_circle = (ProgressBar) findViewById(R.id.circularprogressbar2);
